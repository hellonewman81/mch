        ...
        {page ? (
          <div>
            ...
            <header
              ...
              style={{
                backgroundImage:
                  'url(https://prismic-io.s3.amazonaws.com/mqchiro%2F301f423a-dc6a-464b-9429-c1a6036e4b0e_blog-chiro.png)',
                height: '50vh',
                minHeight: '50vh',
              }}
            ...
            <header className="masthead">
              <div className="container">
                <div className="intro-text">
                  <div className="intro-lead-in">Welcome To MQ Chiro!</div>
